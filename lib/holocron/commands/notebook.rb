  ...
  module Commands
    class Notebook < BaseCommand
      ...
      def new_notebook
        ...
        notebook_path = File.join(@holocron_directory, '_memory', 'notebooks', "#{@name}.md")
      ...
      def list_notebooks
        ...
        notebooks_dir = File.join(@holocron_directory, '_memory', 'notebooks')
      ...
      def show_help
        ...
        puts
        puts 'Use --from-buffer flag to read content from _memory/tmp/buffer'.colorize(:yellow)
      end
      ...
      def generate_sources_list
        ...
        Find.find(@holocron_directory) do |path|
          ...
          next if path.include?('/_memory/notebooks/') # Don't include other notebooks
